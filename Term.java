...
public class Term implements Comparable<Term> {
    ...
    private final long weight; // Query weight
    ...
    private static class ReverseWeightOrder implements Comparator<Term> {
        ...
        public int compare(Term v, Term w) {
            return Long.compare(w.weight, v.weight); // use Long.compare with swap value
        }
    }
    ...
    private static class PrefixOrder implements Comparator<Term> {
        ...
        public int compare(Term v, Term w) {
            String a = v.query.substring(0, Math.min(r, v.query.length())); // substring of v
            String b = w.query.substring(0, Math.min(r, w.query.length())); // substring of w
